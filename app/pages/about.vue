  ...
  <div class="py-5">
    <div class="sm:grid grid-cols-8 px-6 py-5 sm:py-9 gap-5 container max-w-5xl mx-auto">
      <div class="col-span-5 max-w-md">
        <div class="flex justify-between">
          ...
          <div class="sm:hidden block col-span-3 pb-5 dark:text-[#F1F2F4]">
            <NuxtImg src="/image-10-resized.png" width="125" height="115" quality="50" class="rounded-md" />
          </div>
        </div>
      ...
      <div class="hidden sm:block col-span-3">
        <NuxtImg src="/image-10-resized.png" width="450" height="500" quality="50" class="rounded-md" />
      </div>
    </div>
  </div>
</template>
